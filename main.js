...
var FrameRateCount = 0;         // Number of rames since last FPS post
...
// Calls the user overloaded "Init(...)" function and starts the main render loop
function Main()
{
    // Get context handles
...
// This funciton throttles itself to only update at a target FPS
function RenderLoop()
{
